...
public class dialog_FormLoaiPhong extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtTenPhong = new lgnvswing.lgnvTextField();
        ...
        txtTenPhong.setLGNV_placeholderText("Nhập tên loại phòng...");
        txtTenPhong.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTenPhongActionPerformed(evt);
            }
        });
        lgnvPanel1.add(txtTenPhong, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 311, 46));
    ...
    private lgnvswing.lgnvTextField txtGiaPhong;
    private lgnvswing.lgnvTextField txtMoTa;
    private lgnvswing.lgnvTextField txtTenPhong;
